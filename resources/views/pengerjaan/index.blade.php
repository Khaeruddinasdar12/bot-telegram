              ...
              <table class="table table-bordered" style="width:100% !important; ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#keterangan" data-id="{{$dt->id}}" data-keterangan="{{$dt->keterangan}}" title="selesaikan pengerjaan" </button><i class="fa fa-check-square"></i></button></td>
                    </tr>
                    @endforeach
                </tbody>
              </table>
